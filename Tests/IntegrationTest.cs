...
namespace Framework.Tests
{
    ...
    {
        [Test]
        public void EstimateGoogleCloudPriceTest()
        {
            try
            {
                ...
                PricingCalculatorPage.EnterCredentialsOfComputeEngine(computeEngine);
                IJavaScriptExecutor js = (IJavaScriptExecutor)Driver;
                js.ExecuteScript("arguments[0].click()", PricingCalculatorPage.AddToEstimateButton);
                ...
                Assert.AreEqual(Steps.ExtractCostFromMessage(expectedResult), Steps.ExtractCostFromMessage(actualResult));
            }
